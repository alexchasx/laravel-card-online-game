...
class TranslatorTest extends TestCase
{
    ...
    public function getHtmlIdsTestData()
    {
        return array(
            ...
            array('a[rel]', array('ability-anchor', 'nofollow-anchor')),
            array('a[rel="ability"]', array('ability-anchor')),
            array('a[href*="localhost"]', array('ability-anchor')),
            array('a[href*=""]', array()),
            array('a[href^="http"]', array('ability-anchor', 'nofollow-anchor')),
            array('a[href^="http:"]', array('ability-anchor')),
            array('a[href^=""]', array()),
            ...
            array('li:root', array()),
            array('* :root', array()),
            array('*:contains("link")', array('html', 'outer-div', 'ability-anchor', 'nofollow-anchor')),
            array(':CONtains("link")', array('html', 'outer-div', 'ability-anchor', 'nofollow-anchor')),
            ...
            array('a ~ a', array('ability-anchor', 'nofollow-anchor')),
            array('a[rel="ability"] ~ a', array('nofollow-anchor')),
            ...
            array('a[href]', array('ability-anchor', 'nofollow-anchor')),
            array(':not(*)', array()),
            array('a:not([href])', array('name-anchor')),
            array('ol :Not(li[class])', array('first-li', 'second-li', 'li-div', 'fifth-li', 'sixth-li', 'seventh-li')),
            // HTML-specific
            array(':link', array('link-href', 'ability-anchor', 'nofollow-anchor', 'area-href')),
            array(':visited', array()),
            array(':enabled', array('link-href', 'ability-anchor', 'nofollow-anchor', 'checkbox-unchecked', 'text-checked', 'checkbox-checked', 'area-href')),
