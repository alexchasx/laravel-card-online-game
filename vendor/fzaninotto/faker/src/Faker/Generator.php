 ...
 *
 * @method string imageUrl($width = 640, $height = 480, $card_set = null, $randomize = true, $word = null, $gray = false)
 * @method string image($dir = null, $width = 640, $height = 480, $card_set = null, $fullPath = true, $randomize = true, $word = null)
 *
